    ...
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1 dark:bg-gray-900">
      ...
      >
        <div
          ...
          className="from-primary-300 to-primary-500 aspect-[577/310] w-[36rem] bg-gradient-to-r opacity-30"
        />
      </div>
      <div
        aria-hidden="true"
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        ...
        <a
          href="#newsletter"
          className="bg-primary-500 hover:bg-primary-600 flex-none rounded-full px-3.5 py-1 text-sm font-semibold text-white shadow-xs"
        >
          Get the Free Newsletter <span aria-hidden="true">&rarr;</span>
        </a>
      </div>
